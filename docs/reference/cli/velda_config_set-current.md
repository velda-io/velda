---
title: "velda config set-current"
---

## velda config set-current

Set the default profile

```
velda config set-current [default-profile] [flags]
```
...
* [velda config](velda_config.md)	 - Manages configuration for the current account.
