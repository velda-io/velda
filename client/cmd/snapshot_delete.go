...
var snapshotDeleteCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		_, err = client.DeleteSnapshot(cmd.Context(), &proto.DeleteSnapshotRequest{
...
func init() {
	...
	snapshotDeleteCmd.Flags().StringP("instance", "i", "", "Instance that the snapshot belongs to.")
}
