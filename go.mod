...
require (
	...
	github.com/nebius/gosdk v0.0.0-20251027103638-3d8d8840cff3
	...
	velda.io/velda/pkg/agent_runner v0.0.0
	velda.io/velda/pkg/proto v0.0.0
)
...
require (
	...
	github.com/hanwen/go-fuse/v2 v2.9.1-0.20260109090005-01dad59e2820 // indirect
...
replace velda.io/velda/pkg/proto => ./pkg/proto

replace velda.io/velda/pkg/agent_runner => ./pkg/agent_runner
