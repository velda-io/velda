...
// RevokeAccess removes the NFS export that was created for the given instance
// and session.
func (n *LocalNfsAuth) RevokeAccess(ctx context.Context, instanceId int64, sessionId string) error {
