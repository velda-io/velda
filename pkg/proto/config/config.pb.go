...
var file_config_config_proto_rawDesc = []byte{
	...
	0x4e, 0x61, 0x6d, 0x65, 0x50, 0x72, 0x65, 0x66, 0x69, 0x78, 0x22, 0xa7, 0x04, 0x0a, 0x22, 0x41,
	...
	0x75, 0x72, 0x69, 0x74, 0x79, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x73, 0x1a, 0x37, 0x0a, 0x09, 0x54,
	...
	0x52, 0x0b, 0x70, 0x6f, 0x64, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x22, 0x58, 0x0a,
	...
	0x09, 0x52, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x22, 0x86, 0x02, 0x0a, 0x0b, 0x50, 0x72, 0x6f, 0x76,
	...
	0x6f, 0x42, 0x0d, 0x0a, 0x0b, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x65, 0x72,
	0x22, 0x35, 0x0a, 0x15, 0x4b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x50, 0x72,
	0x6f, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x65, 0x72, 0x12, 0x1c, 0x0a, 0x09, 0x6e, 0x61, 0x6d,
	0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x6e, 0x61,
	0x6d, 0x65, 0x73, 0x70, 0x61, 0x63, 0x65, 0x22, 0x91, 0x01, 0x0a, 0x0e, 0x41, 0x57, 0x53, 0x50,
	...
	0x61, 0x74, 0x65, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x22, 0x8a, 0x02, 0x0a, 0x12,
	...
	0x50, 0x72, 0x65, 0x66, 0x69, 0x78, 0x65, 0x73, 0x22, 0x91, 0x01, 0x0a, 0x0e, 0x47, 0x43, 0x53,
	...
	0x65, 0x6e, 0x64, 0x22, 0xa4, 0x02, 0x0a, 0x06, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x2c,
	...
	0x61, 0x6c, 0x6c, 0x6f, 0x77, 0x4e, 0x65, 0x77, 0x50, 0x6f, 0x6f, 0x6c, 0x4a, 0x04, 0x08, 0x02,
	0x10, 0x03, 0x4a, 0x04, 0x08, 0x03, 0x10, 0x04, 0x4a, 0x04, 0x08, 0x07, 0x10, 0x08, 0x4a, 0x04,
	0x08, 0x08, 0x10, 0x09, 0x4a, 0x04, 0x08, 0x0a, 0x10, 0x0b, 0x42, 0x21, 0x5a, 0x1f, 0x76, 0x65,
...
var file_config_config_proto_depIdxs = []int32{
	...
	9,  // 4: velda.config.Provisioner.aws:type_name -> velda.config.AWSProvisioner
	8,  // 5: velda.config.Provisioner.kubernetes:type_name -> velda.config.KubernetesProvisioner
	11, // 6: velda.config.Provisioner.gcs:type_name -> velda.config.GCSProvisioner
	10, // 7: velda.config.Provisioner.aws_auto:type_name -> velda.config.AWSAutoProvisioner
	18, // 8: velda.config.AWSProvisioner.update_interval:type_name -> google.protobuf.Duration
	4,  // 9: velda.config.AWSAutoProvisioner.template:type_name -> velda.config.AutoscalerBackendAWSLaunchTemplate
	16, // 10: velda.config.AWSAutoProvisioner.autoscaler_config:type_name -> velda.config.AgentPool.AutoScaler
	18, // 11: velda.config.GCSProvisioner.update_interval:type_name -> google.protobuf.Duration
	3,  // 12: velda.config.AutoscalerBackend.gce_instance_group:type_name -> velda.config.AutoscalerBackendGCEInstanceGroup
	4,  // 13: velda.config.AutoscalerBackend.aws_launch_template:type_name -> velda.config.AutoscalerBackendAWSLaunchTemplate
	5,  // 14: velda.config.AutoscalerBackend.kubernetes:type_name -> velda.config.AutoscalerBackendKubernetes
	6,  // 15: velda.config.AutoscalerBackend.command:type_name -> velda.config.AutoscalerBackendCommand
	0,  // 16: velda.config.Config.server:type_name -> velda.config.Server
	1,  // 17: velda.config.Config.storage:type_name -> velda.config.Storage
	2,  // 18: velda.config.Config.agent_pools:type_name -> velda.config.AgentPool
	7,  // 19: velda.config.Config.provisioners:type_name -> velda.config.Provisioner
	12, // 20: velda.config.AgentPool.AutoScaler.backend:type_name -> velda.config.AutoscalerBackend
	18, // 21: velda.config.AgentPool.AutoScaler.idle_decay:type_name -> google.protobuf.Duration
	18, // 22: velda.config.AgentPool.AutoScaler.initial_delay:type_name -> google.protobuf.Duration
	18, // 23: velda.config.AgentPool.AutoScaler.sync_loop_interval:type_name -> google.protobuf.Duration
	18, // 24: velda.config.AgentPool.AutoScaler.kill_unknown_after:type_name -> google.protobuf.Duration
