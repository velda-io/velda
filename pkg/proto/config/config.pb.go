...
var file_config_config_proto_rawDesc = []byte{
	...
	0x22, 0x96, 0x06, 0x0a, 0x09, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x50, 0x6f, 0x6f, 0x6c, 0x12, 0x12,
	...
	0x6f, 0x53, 0x63, 0x61, 0x6c, 0x65, 0x72, 0x1a, 0xaf, 0x05, 0x0a, 0x0a, 0x41, 0x75, 0x74, 0x6f,
	...
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xa6, 0x01, 0x0a, 0x1b, 0x41, 0x75, 0x74, 0x6f, 0x73, 0x63,
	...
	0x61, 0x74, 0x63, 0x68, 0x53, 0x74, 0x61, 0x72, 0x74, 0x22, 0x86, 0x02, 0x0a, 0x0b, 0x50, 0x72,
	...
	0x09, 0x52, 0x05, 0x61, 0x6d, 0x69, 0x49, 0x64, 0x22, 0x91, 0x01, 0x0a, 0x0e, 0x47, 0x43, 0x53,
	...
	0x0b, 0x32, 0x19, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x62, 0x75, 0x66, 0x2e, 0x44, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x0e, 0x75, 0x70,
	0x64, 0x61, 0x74, 0x65, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x22, 0xf4, 0x02, 0x0a,
	...
	0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x12, 0x4b, 0x0a, 0x0a, 0x6b, 0x75, 0x62, 0x65, 0x72,
	...
	0x65, 0x6e, 0x64, 0x22, 0xf3, 0x02, 0x0a, 0x06, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x2c,
	...
	0x72, 0x49, 0x6e, 0x66, 0x6f, 0x4a, 0x04, 0x08, 0x02, 0x10, 0x03, 0x4a, 0x04, 0x08, 0x03, 0x10,
	0x04, 0x4a, 0x04, 0x08, 0x07, 0x10, 0x08, 0x4a, 0x04, 0x08, 0x08, 0x10, 0x09, 0x4a, 0x04, 0x08,
	0x0a, 0x10, 0x0b, 0x4a, 0x04, 0x08, 0x32, 0x10, 0x64, 0x42, 0x21, 0x5a, 0x1f, 0x76, 0x65, 0x6c,
...
var file_config_config_proto_msgTypes = make([]protoimpl.MessageInfo, 20)
var file_config_config_proto_goTypes = []any{
	...
	(*AutoscalerBackendKubernetes)(nil),                  // 7: velda.config.AutoscalerBackendKubernetes
	(*AutoscalerBackendCommand)(nil),                     // 8: velda.config.AutoscalerBackendCommand
	(*Provisioner)(nil),                                  // 9: velda.config.Provisioner
	(*KubernetesProvisioner)(nil),                        // 10: velda.config.KubernetesProvisioner
	(*AWSProvisioner)(nil),                               // 11: velda.config.AWSProvisioner
	(*AWSAutoProvisioner)(nil),                           // 12: velda.config.AWSAutoProvisioner
	(*GCSProvisioner)(nil),                               // 13: velda.config.GCSProvisioner
	(*AutoscalerBackend)(nil),                            // 14: velda.config.AutoscalerBackend
	(*Config)(nil),                                       // 15: velda.config.Config
	(*Storage_Zfs)(nil),                                  // 16: velda.config.Storage.Zfs
	(*Storage_MiniVelda)(nil),                            // 17: velda.config.Storage.MiniVelda
	(*AgentPool_AutoScaler)(nil),                         // 18: velda.config.AgentPool.AutoScaler
	nil,                                                  // 19: velda.config.AutoscalerBackendAWSLaunchTemplate.TagsEntry
	(*KubernetesProvisioner_GoogleKubernetesEngine)(nil), // 20: velda.config.KubernetesProvisioner.GoogleKubernetesEngine
	(*agent.AgentConfig)(nil),                            // 21: velda.agent.AgentConfig
	(*durationpb.Duration)(nil),                          // 22: google.protobuf.Duration
	(*agent.BrokerInfo)(nil),                             // 23: velda.agent.BrokerInfo
}
var file_config_config_proto_depIdxs = []int32{
	16, // 0: velda.config.Storage.zfs:type_name -> velda.config.Storage.Zfs
	17, // 1: velda.config.Storage.mini:type_name -> velda.config.Storage.MiniVelda
	18, // 2: velda.config.AgentPool.auto_scaler:type_name -> velda.config.AgentPool.AutoScaler
	21, // 3: velda.config.AutoscalerBackendAWSLaunchTemplate.agent_config:type_name -> velda.agent.AgentConfig
	19, // 4: velda.config.AutoscalerBackendAWSLaunchTemplate.tags:type_name -> velda.config.AutoscalerBackendAWSLaunchTemplate.TagsEntry
	22, // 5: velda.config.AutoscalerBackendAWSLaunchTemplate.max_instance_lifetime:type_name -> google.protobuf.Duration
	11, // 6: velda.config.Provisioner.aws:type_name -> velda.config.AWSProvisioner
	10, // 7: velda.config.Provisioner.kubernetes:type_name -> velda.config.KubernetesProvisioner
	13, // 8: velda.config.Provisioner.gcs:type_name -> velda.config.GCSProvisioner
	12, // 9: velda.config.Provisioner.aws_auto:type_name -> velda.config.AWSAutoProvisioner
	20, // 10: velda.config.KubernetesProvisioner.gke:type_name -> velda.config.KubernetesProvisioner.GoogleKubernetesEngine
	22, // 11: velda.config.AWSProvisioner.update_interval:type_name -> google.protobuf.Duration
	6,  // 12: velda.config.AWSAutoProvisioner.template:type_name -> velda.config.AutoscalerBackendAWSLaunchTemplate
	18, // 13: velda.config.AWSAutoProvisioner.autoscaler_config:type_name -> velda.config.AgentPool.AutoScaler
	22, // 14: velda.config.GCSProvisioner.update_interval:type_name -> google.protobuf.Duration
	5,  // 15: velda.config.AutoscalerBackend.gce_instance_group:type_name -> velda.config.AutoscalerBackendGCEInstanceGroup
	6,  // 16: velda.config.AutoscalerBackend.aws_launch_template:type_name -> velda.config.AutoscalerBackendAWSLaunchTemplate
	7,  // 17: velda.config.AutoscalerBackend.kubernetes:type_name -> velda.config.AutoscalerBackendKubernetes
	8,  // 18: velda.config.AutoscalerBackend.command:type_name -> velda.config.AutoscalerBackendCommand
	...
	4,  // 21: velda.config.Config.agent_pools:type_name -> velda.config.AgentPool
	9,  // 22: velda.config.Config.provisioners:type_name -> velda.config.Provisioner
	23, // 23: velda.config.Config.default_broker_info:type_name -> velda.agent.BrokerInfo
	14, // 24: velda.config.AgentPool.AutoScaler.backend:type_name -> velda.config.AutoscalerBackend
	22, // 25: velda.config.AgentPool.AutoScaler.idle_decay:type_name -> google.protobuf.Duration
	22, // 26: velda.config.AgentPool.AutoScaler.initial_delay:type_name -> google.protobuf.Duration
	22, // 27: velda.config.AgentPool.AutoScaler.sync_loop_interval:type_name -> google.protobuf.Duration
	22, // 28: velda.config.AgentPool.AutoScaler.kill_unknown_after:type_name -> google.protobuf.Duration
	0,  // 29: velda.config.AgentPool.AutoScaler.mode:type_name -> velda.config.AgentPool.AutoScaler.Mode
	3,  // 30: velda.config.AgentPool.AutoScaler.metadata:type_name -> velda.config.PoolMetadata
