...
var file_config_config_proto_rawDesc = []byte{
	...
	0x0a, 0x07, 0x62, 0x61, 0x63, 0x6b, 0x65, 0x6e, 0x64, 0x22, 0xa4, 0x02, 0x0a, 0x06, 0x43, 0x6f,
	...
	0x6f, 0x6c, 0x4a, 0x04, 0x08, 0x02, 0x10, 0x03, 0x4a, 0x04, 0x08, 0x03, 0x10, 0x04, 0x4a, 0x04,
...
var file_config_config_proto_goTypes = []any{
	...
	(*KubernetesProvisioner_GoogleKubernetesEngine)(nil), // 18: velda.config.KubernetesProvisioner.GoogleKubernetesEngine
...
var file_config_config_proto_depIdxs = []int32{
	...
	19, // 4: velda.config.AutoscalerBackendAWSLaunchTemplate.max_instance_lifetime:type_name -> google.protobuf.Duration
	...
	18, // 9: velda.config.KubernetesProvisioner.gke:type_name -> velda.config.KubernetesProvisioner.GoogleKubernetesEngine
	19, // 10: velda.config.AWSProvisioner.update_interval:type_name -> google.protobuf.Duration
	4,  // 11: velda.config.AWSAutoProvisioner.template:type_name -> velda.config.AutoscalerBackendAWSLaunchTemplate
	16, // 12: velda.config.AWSAutoProvisioner.autoscaler_config:type_name -> velda.config.AgentPool.AutoScaler
	19, // 13: velda.config.GCSProvisioner.update_interval:type_name -> google.protobuf.Duration
	3,  // 14: velda.config.AutoscalerBackend.gce_instance_group:type_name -> velda.config.AutoscalerBackendGCEInstanceGroup
	4,  // 15: velda.config.AutoscalerBackend.aws_launch_template:type_name -> velda.config.AutoscalerBackendAWSLaunchTemplate
	5,  // 16: velda.config.AutoscalerBackend.kubernetes:type_name -> velda.config.AutoscalerBackendKubernetes
	6,  // 17: velda.config.AutoscalerBackend.command:type_name -> velda.config.AutoscalerBackendCommand
	0,  // 18: velda.config.Config.server:type_name -> velda.config.Server
	1,  // 19: velda.config.Config.storage:type_name -> velda.config.Storage
	2,  // 20: velda.config.Config.agent_pools:type_name -> velda.config.AgentPool
	7,  // 21: velda.config.Config.provisioners:type_name -> velda.config.Provisioner
	12, // 22: velda.config.AgentPool.AutoScaler.backend:type_name -> velda.config.AutoscalerBackend
	19, // 23: velda.config.AgentPool.AutoScaler.idle_decay:type_name -> google.protobuf.Duration
	19, // 24: velda.config.AgentPool.AutoScaler.initial_delay:type_name -> google.protobuf.Duration
	19, // 25: velda.config.AgentPool.AutoScaler.sync_loop_interval:type_name -> google.protobuf.Duration
	19, // 26: velda.config.AgentPool.AutoScaler.kill_unknown_after:type_name -> google.protobuf.Duration
