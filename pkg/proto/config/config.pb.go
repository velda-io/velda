...
var file_config_config_proto_rawDesc = []byte{
	...
	0x4e, 0x61, 0x6d, 0x65, 0x50, 0x72, 0x65, 0x66, 0x69, 0x78, 0x22, 0xd6, 0x01, 0x0a, 0x22, 0x41,
	...
	0x0b, 0x70, 0x6f, 0x64, 0x53, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x6f, 0x72, 0x22, 0x58, 0x0a, 0x18,
	...
	0x52, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x22, 0xc7, 0x01, 0x0a, 0x0b, 0x50, 0x72, 0x6f, 0x76, 0x69,
	0x73, 0x69, 0x6f, 0x6e, 0x65, 0x72, 0x12, 0x30, 0x0a, 0x03, 0x61, 0x77, 0x73, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x76, 0x65, 0x6c, 0x64, 0x61, 0x2e, 0x63, 0x6f, 0x6e, 0x66,
	0x69, 0x67, 0x2e, 0x41, 0x57, 0x53, 0x50, 0x72, 0x6f, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x65,
	0x72, 0x48, 0x00, 0x52, 0x03, 0x61, 0x77, 0x73, 0x12, 0x45, 0x0a, 0x0a, 0x6b, 0x75, 0x62, 0x65,
	0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x23, 0x2e, 0x76,
	...
	0x72, 0x48, 0x00, 0x52, 0x0a, 0x6b, 0x75, 0x62, 0x65, 0x72, 0x6e, 0x65, 0x74, 0x65, 0x73, 0x12,
	0x30, 0x0a, 0x03, 0x67, 0x63, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x76,
	0x65, 0x6c, 0x64, 0x61, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x47, 0x43, 0x53, 0x50,
	0x72, 0x6f, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x65, 0x72, 0x48, 0x00, 0x52, 0x03, 0x67, 0x63,
	0x73, 0x42, 0x0d, 0x0a, 0x0b, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x65, 0x72,
	...
	0x61, 0x74, 0x65, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x76, 0x61, 0x6c, 0x22, 0x91, 0x01, 0x0a, 0x0e,
...
var file_config_config_proto_goTypes = []any{
	...
	(*GCSProvisioner)(nil),                     // 10: velda.config.GCSProvisioner
	(*AutoscalerBackend)(nil),                  // 11: velda.config.AutoscalerBackend
	(*Config)(nil),                             // 12: velda.config.Config
	(*Storage_Zfs)(nil),                        // 13: velda.config.Storage.Zfs
	(*Storage_MiniVelda)(nil),                  // 14: velda.config.Storage.MiniVelda
	(*AgentPool_AutoScaler)(nil),               // 15: velda.config.AgentPool.AutoScaler
	(*durationpb.Duration)(nil),                // 16: google.protobuf.Duration
}
var file_config_config_proto_depIdxs = []int32{
	13, // 0: velda.config.Storage.zfs:type_name -> velda.config.Storage.Zfs
	14, // 1: velda.config.Storage.mini:type_name -> velda.config.Storage.MiniVelda
	15, // 2: velda.config.AgentPool.auto_scaler:type_name -> velda.config.AgentPool.AutoScaler
	9,  // 3: velda.config.Provisioner.aws:type_name -> velda.config.AWSProvisioner
	8,  // 4: velda.config.Provisioner.kubernetes:type_name -> velda.config.KubernetesProvisioner
	10, // 5: velda.config.Provisioner.gcs:type_name -> velda.config.GCSProvisioner
	16, // 6: velda.config.AWSProvisioner.update_interval:type_name -> google.protobuf.Duration
	16, // 7: velda.config.GCSProvisioner.update_interval:type_name -> google.protobuf.Duration
	3,  // 8: velda.config.AutoscalerBackend.gce_instance_group:type_name -> velda.config.AutoscalerBackendGCEInstanceGroup
	4,  // 9: velda.config.AutoscalerBackend.aws_launch_template:type_name -> velda.config.AutoscalerBackendAWSLaunchTemplate
	5,  // 10: velda.config.AutoscalerBackend.kubernetes:type_name -> velda.config.AutoscalerBackendKubernetes
	6,  // 11: velda.config.AutoscalerBackend.command:type_name -> velda.config.AutoscalerBackendCommand
	0,  // 12: velda.config.Config.server:type_name -> velda.config.Server
	1,  // 13: velda.config.Config.storage:type_name -> velda.config.Storage
	2,  // 14: velda.config.Config.agent_pools:type_name -> velda.config.AgentPool
	7,  // 15: velda.config.Config.provisioners:type_name -> velda.config.Provisioner
	11, // 16: velda.config.AgentPool.AutoScaler.backend:type_name -> velda.config.AutoscalerBackend
	16, // 17: velda.config.AgentPool.AutoScaler.idle_decay:type_name -> google.protobuf.Duration
	16, // 18: velda.config.AgentPool.AutoScaler.initial_delay:type_name -> google.protobuf.Duration
	16, // 19: velda.config.AgentPool.AutoScaler.sync_loop_interval:type_name -> google.protobuf.Duration
	16, // 20: velda.config.AgentPool.AutoScaler.kill_unknown_after:type_name -> google.protobuf.Duration
