...
const (
	...
	SessionExecutionFinalState_SESSION_EXECUTION_FINAL_STATE_NO_QUOTA           SessionExecutionFinalState = 9
)
...
var (
	SessionExecutionFinalState_name = map[int32]string{
		...
		9: "SESSION_EXECUTION_FINAL_STATE_NO_QUOTA",
	}
	SessionExecutionFinalState_value = map[string]int32{
		...
		"SESSION_EXECUTION_FINAL_STATE_NO_QUOTA":           9,
	}
)
...
const (
	...
	// In gang-scheduling, resource has been allocated for this shard.
	ExecutionStatus_STATUS_WAITING_FOR_OTHER_SHARDS ExecutionStatus_Status = 7
	// Cancelled: never sent to agent or killed before started.
	ExecutionStatus_STATUS_CANCELLED ExecutionStatus_Status = 8
)
...
var (
	ExecutionStatus_Status_name = map[int32]string{
		...
		7: "STATUS_WAITING_FOR_OTHER_SHARDS",
		8: "STATUS_CANCELLED",
	}
...
func (ExecutionStatus_Status) EnumDescriptor() ([]byte, []int) {
	return file_broker_proto_rawDescGZIP(), []int{12, 0}
}
...
type AgentIdentity struct {
	...
	// Optional self-reported address for agent-side connectivity.
...
func (x *AgentIdentity) GetIpAddress() string {
	if x != nil {
		return x.IpAddress
	}
	return ""
...
type SessionRequest struct {
	...
	// Key-value tags for the session.
	...
	// When set to true, disallow creating a new session. Only return existing
	// sessions matching the service_name or session_id.
	// If no matching session exists, an error will be returned.
	DisallowNewSession bool `protobuf:"varint,18,opt,name=disallow_new_session,json=disallowNewSession,proto3" json:"disallow_new_session,omitempty"`
...
func (x *SessionRequest) GetTags() map[string]string {
	if x != nil {
		return x.Tags
	}
	return nil
...
func (x *SessionRequest) GetDisallowNewSession() bool {
	if x != nil {
		return x.DisallowNewSession
	}
	return false
}
...
func (x *SessionRequest) GetWritableDirs() []string {
	if x != nil {
...
func (x *SessionRequest) GetSnapshotName() string {
	if x != nil {
...
type KillSessionAgentRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	InstanceId    int64                  `protobuf:"varint,1,opt,name=instance_id,json=instanceId,proto3" json:"instance_id,omitempty"`
	SessionId     string                 `protobuf:"bytes,2,opt,name=session_id,json=sessionId,proto3" json:"session_id,omitempty"`
...
func (x *KillSessionAgentRequest) Reset() {
	*x = KillSessionAgentRequest{}
	mi := &file_broker_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *KillSessionAgentRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*KillSessionAgentRequest) ProtoMessage() {}

func (x *KillSessionAgentRequest) ProtoReflect() protoreflect.Message {
	mi := &file_broker_proto_msgTypes[9]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use KillSessionAgentRequest.ProtoReflect.Descriptor instead.
func (*KillSessionAgentRequest) Descriptor() ([]byte, []int) {
	return file_broker_proto_rawDescGZIP(), []int{9}
}

func (x *KillSessionAgentRequest) GetInstanceId() int64 {
	if x != nil {
		return x.InstanceId
	}
	return 0
...
func (x *KillSessionAgentRequest) GetSessionId() string {
	if x != nil {
		return x.SessionId
	}
	return ""
...
func (x *KillSessionAgentRequest) GetForce() bool {
	if x != nil {
		return x.Force
	}
	return false
...
type AgentUpdateResponse struct {
	...
	KillSessionRequest *KillSessionAgentRequest `protobuf:"bytes,2,opt,name=kill_session_request,json=killSessionRequest,proto3" json:"kill_session_request,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *AgentUpdateResponse) GetServerInfo() *ServerInfo {
	if x != nil {
		return x.ServerInfo
	}
	return nil
...
func (x *AgentUpdateResponse) GetKillSessionRequest() *KillSessionAgentRequest {
	if x != nil {
		return x.KillSessionRequest
	}
	return nil
}
...
func (x *KillSessionRequest) GetInstanceId() int64 {
	if x != nil {
		return x.InstanceId
	}
	return 0
...
func (x *KillSessionRequest) GetServiceName() string {
	if x != nil {
		return x.ServiceName
	}
	return ""
...
type SetTagRequest struct {
	...
	InstanceId int64                  `protobuf:"varint,1,opt,name=instance_id,json=instanceId,proto3" json:"instance_id,omitempty"`
	SessionId  string                 `protobuf:"bytes,2,opt,name=session_id,json=sessionId,proto3" json:"session_id,omitempty"`
	// Tags to set or update. If a tag value is empty, the tag will be removed.
...
func (x *SetTagRequest) GetInstanceId() int64 {
	if x != nil {
		return x.InstanceId
	}
	return 0
...
func (x *SetTagRequest) GetSessionId() string {
	if x != nil {
		return x.SessionId
	}
	return ""
...
func (x *SetTagRequest) GetTags() map[string]string {
	if x != nil {
		return x.Tags
	}
	return nil
...
type AgentSessionInfo_NfsMount struct {
	...
	NfsSnapshotPath string                 `protobuf:"bytes,3,opt,name=nfs_snapshot_path,json=nfsSnapshotPath,proto3" json:"nfs_snapshot_path,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *AgentSessionInfo_NfsMount) GetNfsSnapshotPath() string {
	if x != nil {
		return x.NfsSnapshotPath
	}
	return ""
}
...
type ExecutionStatus_SshConnection struct {
	...
	// If provided, it will be used as a jump server to connect to the agent.
	// This is not used with user-based authentication.
	JumpHost      string `protobuf:"bytes,4,opt,name=jump_host,json=jumpHost,proto3" json:"jump_host,omitempty"`
	JumpHostKey   []byte `protobuf:"bytes,5,opt,name=jump_host_key,json=jumpHostKey,proto3" json:"jump_host_key,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ExecutionStatus_SshConnection) GetJumpHost() string {
	if x != nil {
		return x.JumpHost
	}
	return ""
...
func (x *ExecutionStatus_SshConnection) GetJumpHostKey() []byte {
	if x != nil {
...
var file_broker_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x79, 0x0a, 0x0d, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x65, 0x6e, 0x74,
	...
	,
	...
	0x63, 0x65, 0x49, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x6f, 0x6f, 0x6c, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x04, 0x70, 0x6f, 0x6f, 0x6c, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x65, 0x73, 0x73,
	0x69, 0x6f, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x73, 0x65,
	0x73, 0x73, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x19, 0x0a, 0x08, 0x61, 0x67, 0x65, 0x6e, 0x74,
	...
	,
	...
	0x70, 0x6f, 0x6f, 0x6c, 0x12, 0x3c, 0x0a, 0x0c, 0x69, 0x6e, 0x69, 0x74, 0x5f, 0x74, 0x69, 0x6d,
	0x65, 0x6f, 0x75, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x67, 0x6f, 0x6f,
	0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x44, 0x75, 0x72,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x0b, 0x69, 0x6e, 0x69, 0x74, 0x54, 0x69, 0x6d, 0x65, 0x6f,
	...
	,
	...
	,
	...
	,
	...
	0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1d, 0x2e, 0x76, 0x65, 0x6c, 0x64, 0x61, 0x2e, 0x45, 0x78,
	...
	,
	...
	0x05, 0x52, 0x04, 0x70, 0x6f, 0x72, 0x74, 0x12, 0x19, 0x0a, 0x08, 0x68, 0x6f, 0x73, 0x74, 0x5f,
	0x6b, 0x65, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x07, 0x68, 0x6f, 0x73, 0x74, 0x4b,
	0x65, 0x79, 0x12, 0x1b, 0x0a, 0x09, 0x6a, 0x75, 0x6d, 0x70, 0x5f, 0x68, 0x6f, 0x73, 0x74, 0x18,
	0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x6a, 0x75, 0x6d, 0x70, 0x48, 0x6f, 0x73, 0x74, 0x12,
	0x22, 0x0a, 0x0d, 0x6a, 0x75, 0x6d, 0x70, 0x5f, 0x68, 0x6f, 0x73, 0x74, 0x5f, 0x6b, 0x65, 0x79,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0b, 0x6a, 0x75, 0x6d, 0x70, 0x48, 0x6f, 0x73, 0x74,
	0x4b, 0x65, 0x79, 0x22, 0xda, 0x01, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x16,
	...
	0x5f, 0x51, 0x55, 0x45, 0x55, 0x45, 0x49, 0x4e, 0x47, 0x10, 0x01, 0x12, 0x12, 0x0a, 0x0e, 0x53,
	...
	,
	...
	0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x49, 0x64, 0x12, 0x21, 0x0a, 0x0c, 0x73, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b,
	0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0xfa, 0x02, 0x0a, 0x07,
	...
	0x73, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x75, 0x73, 0x65, 0x72, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x6f,
	0x6f, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x6f, 0x6f, 0x6c, 0x12, 0x1f,
	...
	0x1d, 0x2e, 0x76, 0x65, 0x6c, 0x64, 0x61, 0x2e, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f,
	0x6e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x06,
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x21, 0x0a, 0x0c, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x73, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x6c, 0x61, 0x62,
	...
	0x73, 0x12, 0x2c, 0x0a, 0x04, 0x74, 0x61, 0x67, 0x73, 0x18, 0x09, 0x20, 0x03, 0x28, 0x0b, 0x32,
	0x18, 0x2e, 0x76, 0x65, 0x6c, 0x64, 0x61, 0x2e, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x2e,
	...
	0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x42, 0x0a, 0x14, 0x4c, 0x69, 0x73, 0x74,
	0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x12, 0x2a, 0x0a, 0x08, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x01, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x76, 0x65, 0x6c, 0x64, 0x61, 0x2e, 0x53, 0x65, 0x73, 0x73, 0x69,
	0x6f, 0x6e, 0x52, 0x08, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x56, 0x0a, 0x14,
	0x41, 0x74, 0x74, 0x61, 0x63, 0x68, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71,
	...
	0x6f, 0x6e, 0x49, 0x64, 0x22, 0x8d, 0x01, 0x0a, 0x12, 0x4b, 0x69, 0x6c, 0x6c, 0x53, 0x65, 0x73,
	0x73, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x1f, 0x0a, 0x0b, 0x69,
	...
	0x6f, 0x72, 0x63, 0x65, 0x22, 0xbc, 0x01, 0x0a, 0x0d, 0x53, 0x65, 0x74, 0x54, 0x61, 0x67, 0x52,
	...
	0x74, 0x61, 0x6e, 0x63, 0x65, 0x49, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x65, 0x73, 0x73, 0x69,
	0x6f, 0x6e, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x73, 0x65, 0x73,
	0x73, 0x69, 0x6f, 0x6e, 0x49, 0x64, 0x12, 0x32, 0x0a, 0x04, 0x74, 0x61, 0x67, 0x73, 0x18, 0x03,
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x76, 0x65, 0x6c, 0x64, 0x61, 0x2e, 0x53, 0x65, 0x74,
	0x54, 0x61, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x2e, 0x54, 0x61, 0x67, 0x73, 0x45,
	...
	,
	...
	,
	...
	0x1c, 0x2f, 0x72, 0x65, 0x73, 0x74, 0x2f, 0x62, 0x72, 0x6f, 0x6b, 0x65, 0x72, 0x2f, 0x76, 0x31,
	0x2f, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x2f, 0x6b, 0x69, 0x6c, 0x6c, 0x12, 0x69, 0x0a,
	0x0c, 0x4c, 0x69, 0x73, 0x74, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x1a, 0x2e,
	0x76, 0x65, 0x6c, 0x64, 0x61, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f,
	0x6e, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1b, 0x2e, 0x76, 0x65, 0x6c, 0x64,
	...
	,
...
var file_broker_proto_goTypes = []any{
	...
	(*KillSessionAgentRequest)(nil),            // 13: velda.KillSessionAgentRequest
	(*ServerInfo)(nil),                         // 14: velda.ServerInfo
	(*AgentUpdateResponse)(nil),                // 15: velda.AgentUpdateResponse
	(*ExecutionStatus)(nil),                    // 16: velda.ExecutionStatus
	(*ListSessionsRequest)(nil),                // 17: velda.ListSessionsRequest
	(*Session)(nil),                            // 18: velda.Session
	(*ListSessionsResponse)(nil),               // 19: velda.ListSessionsResponse
	(*AttachSessionRequest)(nil),               // 20: velda.AttachSessionRequest
	(*KillSessionRequest)(nil),                 // 21: velda.KillSessionRequest
	(*SetTagRequest)(nil),                      // 22: velda.SetTagRequest
	(*SetTagResponse)(nil),                     // 23: velda.SetTagResponse
	nil,                                        // 24: velda.SessionRequest.TagsEntry
	(*AgentSessionInfo_NfsMount)(nil),          // 25: velda.AgentSessionInfo.NfsMount
	(*ExecutionStatus_SshConnection)(nil),      // 26: velda.ExecutionStatus.SshConnection
	nil,                                        // 27: velda.Session.TagsEntry
	nil,                                        // 28: velda.SetTagRequest.TagsEntry
	(*timestamppb.Timestamp)(nil),              // 29: google.protobuf.Timestamp
	(*durationpb.Duration)(nil),                // 30: google.protobuf.Duration
	(*Workload)(nil),                           // 31: velda.Workload
	(*BatchTaskResult)(nil),                    // 32: velda.BatchTaskResult
...
var file_broker_proto_depIdxs = []int32{
	...
	29, // 4: velda.SessionExecutionRecord.create_time:type_name -> google.protobuf.Timestamp
	29, // 5: velda.SessionExecutionRecord.start_time:type_name -> google.protobuf.Timestamp
	29, // 6: velda.SessionExecutionRecord.end_time:type_name -> google.protobuf.Timestamp
	...
	30, // 11: velda.SessionRequest.init_timeout:type_name -> google.protobuf.Duration
	30, // 12: velda.SessionRequest.idle_timeout:type_name -> google.protobuf.Duration
	31, // 13: velda.SessionRequest.workload:type_name -> velda.Workload
	24, // 14: velda.SessionRequest.tags:type_name -> velda.SessionRequest.TagsEntry
	8,  // 15: velda.SessionRequest.dependencies:type_name -> velda.Dependency
	2,  // 16: velda.SessionRequest.connection_finish_action:type_name -> velda.SessionRequest.ConnectionFinishAction
	10, // 17: velda.SessionRequest.agent_session_info:type_name -> velda.AgentSessionInfo
	25, // 18: velda.AgentSessionInfo.nfs_mount:type_name -> velda.AgentSessionInfo.NfsMount
	32, // 19: velda.SessionCompletion.batch_task_result:type_name -> velda.BatchTaskResult
	14, // 20: velda.AgentUpdateResponse.server_info:type_name -> velda.ServerInfo
	9,  // 21: velda.AgentUpdateResponse.session_request:type_name -> velda.SessionRequest
	13, // 22: velda.AgentUpdateResponse.kill_session_request:type_name -> velda.KillSessionAgentRequest
	3,  // 23: velda.ExecutionStatus.status:type_name -> velda.ExecutionStatus.Status
	26, // 24: velda.ExecutionStatus.ssh_connection:type_name -> velda.ExecutionStatus.SshConnection
	29, // 25: velda.ExecutionStatus.started_at:type_name -> google.protobuf.Timestamp
	3,  // 26: velda.Session.status:type_name -> velda.ExecutionStatus.Status
	27, // 27: velda.Session.tags:type_name -> velda.Session.TagsEntry
	18, // 28: velda.ListSessionsResponse.sessions:type_name -> velda.Session
	28, // 29: velda.SetTagRequest.tags:type_name -> velda.SetTagRequest.TagsEntry
	5,  // 30: velda.BrokerService.AgentUpdate:input_type -> velda.AgentUpdateRequest
	9,  // 31: velda.BrokerService.RequestSession:input_type -> velda.SessionRequest
	21, // 32: velda.BrokerService.KillSession:input_type -> velda.KillSessionRequest
	17, // 33: velda.BrokerService.ListSessions:input_type -> velda.ListSessionsRequest
	22, // 34: velda.BrokerService.SetTag:input_type -> velda.SetTagRequest
	15, // 35: velda.BrokerService.AgentUpdate:output_type -> velda.AgentUpdateResponse
	16, // 36: velda.BrokerService.RequestSession:output_type -> velda.ExecutionStatus
	33, // 37: velda.BrokerService.KillSession:output_type -> google.protobuf.Empty
	19, // 38: velda.BrokerService.ListSessions:output_type -> velda.ListSessionsResponse
	23, // 39: velda.BrokerService.SetTag:output_type -> velda.SetTagResponse
